...
public class BusStop {
    ...
    public Hashtable<String, Double> ServiceOrderTiming;
    public Hashtable<String, Directions> directionsTable;
            ...
            while (sheetCount <= 4) {
                ...
                while (itr.hasNext()) {
                    ...
                    while (currentRow <= totalRowCount) {
                        ...
                        double durationInSeconds = sheet.getRow(currentRow).getCell(6).getNumericCellValue() - currBusStop.ServiceOrderTiming.get(currServiceString);
                        ...
                        currentRow++;
                        System.out.println(destinationBusStopString + "has been assigned to " + currBusStopString);
                    }
                }
                sheetCount++;
            }
