...
public class NUSGoBot extends TelegramLongPollingBot {
    ...
    public void onUpdateReceived(Update update) {
        ...
        if (update.hasMessage() && update.getMessage().hasText()) { // check for new message
            String text_message = update.getMessage().getText();
            if (text_message.equals("/start")) { // start NUSGoBot
            ...
            } else if (text_message.equals("Send Current Location")) { // user sent current location
