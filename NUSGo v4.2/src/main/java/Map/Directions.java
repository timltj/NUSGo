...
public class Directions {
    ...
    public String toString() {
        if (this.sameLocation) {
            return "Walk Straight for 1 minute \n2. Turn Left and walk straight for 1 minute \n3. Turn Left and walk straight for 1 minute \n4. Turn Left and walk straight for 1 minute\n\nDon't disturb my bot leh...\nIt's the same place right...";
        } else if (mode == BUS) {
            if (currentlyRunning) {
                return "Board " + this.busNumber + "(Bus Freq: " + this.waitingTime + "min) from " + this.startingLocation + " and alight at " + this.endingLocation + " after " + this.duration + " minutes";
            } else {
                return "Board " + this.busNumber + " from " + this.startingLocation + " and alight at "
                        + this.endingLocation + " after " + this.duration + " minutes"
                        + "\nThis service is not running at this moment, check /" + "servicetimings" + this.busNumber + " for the next service.";
            }
