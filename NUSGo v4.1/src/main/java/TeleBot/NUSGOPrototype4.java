...
public class NUSGOPrototype4 extends TelegramLongPollingBot {
    ...
    private static boolean botNoServiceFlag = false;
    ...
    public void refresh() {
        ...
        NUSGOPrototype4.botNoServiceFlag = false;
    }
    ...
    public void onUpdateReceived(Update update) {
        ...
        SendMessage service_timings_enabled_message = new SendMessage()
                .setChatId(chat_id)
                .setText("This is the next available service for bus ");
        ...
        if (update.hasMessage() && update.getMessage().hasText()) { // CHECK USER INPUT
            ...
            if (text_message.equals("/start") || text_message.equals("/restart")) { // HOME page
                ...
                if (botNoServiceFlag) {
                    message = service_timings_enabled_message; /* ADD NEXT BUS SERVICE HERE */
                } else {
                    message = service_timings_disabled_message;
                }
                ...
                if (text_message.substring(1, 3).equals(". ")) { // check if this is a user selection
                    ...
                    if (page.equals(Page.SEARCH_LOCATION_START_UPDATE)) {
                        ...
                        if (answerRoute.getNoServiceFlag()) { // enable service timings command
                            botNoServiceFlag = true;
